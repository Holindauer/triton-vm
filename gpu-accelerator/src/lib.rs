...
impl FutharkContext {
pub fn test_gpu_kernel(&mut self, in0: u64, ) -> Result<(u64)>
{
let ctx = self.ptr();
unsafe{
_test_gpu_kernel(ctx, in0, )
}}

}
unsafe fn _test_gpu_kernel(ctx: *mut bindings::futhark_context, in0: u64, ) -> Result<(u64)> {
let mut raw_out0 = u64::default();

if bindings::futhark_entry_test_gpu_kernel(ctx, &mut raw_out0, in0, ) != 0 {
